...
def show_alerts_page():
    ...
    with tab1:
        ...
        with col1:
            filter_type = st.selectbox("النوع", ["الكل", "💰 أسعار", "📦 مخزون", "🏪 منافسين", "⚙️ نظام"])
        
        with col2:
            filter_priority = st.selectbox("الأولوية", ["الكل", "عاجلة", "عالية", "متوسطة", "منخفضة"])
        
        with col3:
            filter_status = st.selectbox("الحالة", ["الكل", "غير مقروء", "مقروء", "تم الحل"])
    ...
    with tab3:
        ...
        with col1:
            start_date = st.date_input("من تاريخ", datetime.now() - timedelta(days=7))
