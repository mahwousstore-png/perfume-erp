"""
app.py
نظام التسعير الذكي للعطور v14.1
═══════════════════════════════════
...
# ── إعدادات الصفحة ─────────────────────────────────────────
st.set_page_config(
    page_title="نظام التسعير الذكي v14.1",
    page_icon="💎",
    layout="wide",
...
# ══════════════════════════════════════════════════════════════
    ...
    with tab4:
        ...
        st.json({
            "الإصدار": "v14.1 - نظام متكامل مع AI",
...
<div style="text-align: center; color: #888; padding: 10px;">
    💎 نظام التسعير الذكي v14.1 | مهووس للعطور | 2026
</div>
""", unsafe_allow_html=True)
